...
class Aplicacion:
    ...
    def agregar_componentes(self):
        ...
        self.label2=ttk.Label(self.labelframe1, text="Ingreseel valor de b:")
        ...
        self.label3=ttk.Label(self.labelframe1, text="Ingreseel valor de c:")
        ...
        self.boton1=ttk.Button(self.labelframe1, text="Calcular", command=self.sumar)
