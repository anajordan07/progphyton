#Leer una lista de 5 empleados nombre y tras sueldos
...
#Visualizar empleados con un monto trimestral mayor a 1000
def visualizarSuperior (empleados):
print("los empleados con un monto trimestral de 1000 son:")
    for empleado in empleados:
        total=0
        for sueldo in empleado[1]:
            total=total+sueldo
